...
$(document).ready(function(){
    ...
    $('#search').click(function(){
        ...
        $.ajax({
            url:"http://api.openweathermap.org/data/2.5/forecast?q=" + text +"&units=metric&appid=96252dec9c05de24a0b216615e8d7777",
            success: function (data) {
...
//https://weatherworld09.herokuapp.com/index.html
